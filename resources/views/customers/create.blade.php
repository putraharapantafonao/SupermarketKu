<x-app-layout>
    <x-slot name="header">
        <div class="space-y-1">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Tambah Pelanggan</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Daftarkan data pelanggan atau member baru SupermarketKu</p>
        </div>
    </x-slot>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-5 sm:p-6">
            ...
            <form action="{{ route('customers.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan nama lengkap pelanggan..."
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Contoh: pelanggan@email.com..."
