<x-app-layout>
    <x-slot name="header">
        <div class="space-y-1">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">Edit Promo</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi program diskon atau promosi SupermarketKu</p>
        </div>
    </x-slot>
            ...
            <form action="{{ route('promotions.update', $promotion->id) }}" method="POST" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col gap-1 md:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $promotion->name) }}" placeholder="Contoh: Promo JSM Gajian, Diskon Akhir Tahun..."
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="number" name="value" value="{{ old('value', $promotion->value) }}" placeholder="Contoh: 10 untuk persen, 5000 untuk rupiah..."
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" name="start_date" value="{{ old('start_date', \Carbon\Carbon::parse($promotion->start_date)->format('Y-m-d')) }}"
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" name="end_date" value="{{ old('end_date', \Carbon\Carbon::parse($promotion->end_date)->format('Y-m-d')) }}"
