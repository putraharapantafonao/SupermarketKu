...
// Langsung alihkan ke halaman login
Route::get('/', function () {
...
Route::middleware(['auth'])->group(function () {
    ...
    |--------------------------------------------------------------------------
    |*/
    Route::resource('categories', CategoryController::class)->middleware('role:Owner,Admin,Gudang');
    Route::resource('products', ProductController::class)->middleware('role:Owner,Admin,Gudang');
    Route::resource('suppliers', SupplierController::class)->middleware('role:Owner,Admin,Gudang');
    Route::resource('customers', CustomerController::class)->middleware('role:Owner,Admin,Kasir');
    ...
    Route::middleware('role:Owner,Admin,Kasir')->group(function () {
        ...
        Route::post('/pos/increase', [PosController::class, 'increaseQuantity'])->name('pos.increase');
        Route::post('/pos/decrease', [PosController::class, 'decreaseQuantity'])->name('pos.decrease');
        ...
        Route::post('/pos/checkout', [PosController::class, 'processCheckout'])->name('pos.processCheckout');
    });
...
/*
|--------------------------------------------------------------------------
| Pembersihan Cache (Shared Hosting Help)
|--------------------------------------------------------------------------
|*/
Route::get('/clear', function() {
    ...
    return "Semua cache Laravel di server hosting berhasil dibersihkan!";
});
